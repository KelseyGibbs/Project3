    ...
    return (
      ...
      <h1>Add a <b>new</b> product</h1>
        <form>
          ...
          <Input value={this.state.inventory} onChange={this.handleInputChange} name="inventory" placeholder="Inventory (required)" />
          <Input value={this.state.price} onChange={this.handleInputChange} name="price" placeholder="Price (required)" />
          <Input value={this.state.description} onChange={this.handleInputChange} name="description" placeholder="Description (Optional)" />
          <FormBtn
